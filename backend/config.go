...
func MustLoadFromEnv() Config {
	return Config{
		...
		OpenAIURL:     strings.TrimSpace(os.Getenv("OPENAI_PROVIDER_URL")),
		ClaudeURL:     strings.TrimSpace(os.Getenv("ANTHROPIC_PROVIDER_URL")),
		...
		DevGatewayKey: strings.TrimSpace(os.Getenv("GATEWAY_DEV_KEY")),
	}
}
